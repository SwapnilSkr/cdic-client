      ...
      <div className="relative hidden h-full flex-col bg-muted p-10 text-white lg:flex dark:border-r">
        ...
        <div className="relative z-20 mt-auto">
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;This platform has revolutionized how we monitor and fact-check media across multiple
              channels.&rdquo;
            </p>
            <footer className="text-sm">Sofia Chen, Chief Information Officer</footer>
          </blockquote>
        </div>
      </div>
